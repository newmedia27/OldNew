...
class TagsJoinObj extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \app\modules\blog\models\queries\TagsJoinObjQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\blog\models\queries\TagsJoinObjQuery(get_called_class());
    }
}
